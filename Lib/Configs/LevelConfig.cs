...
namespace JailbreakExtras.Lib.Configs
{
    public class LevelConfig
    {
        ...
        public List<LevelGiftConfig> LevelGifts { get; set; } = new()
        {
            ...
            new (5, 5000,    "Seviye 5" , "@css/seviye5", "[Seviye 5]","500 kredi"),
            new (6, 6000,    "Seviye 6" , "@css/seviye6", "[Seviye 6]","team, respawn"),
            new (7, 7000,    "Seviye 7" , "@css/seviye7", "[Seviye 7]","500 kredi"),
            ...
            new (11, 15000,    "Seviye 11" , "@css/seviye11", "[Seviye 11]","1000 kredi"),
            new (12, 20000,    "Seviye 12" , "@css/seviye12", "[Seviye 12]","1000 kredi"),
            new (13, 25000,    "Seviye 13" , "@css/seviye13", "[Seviye 13]","1000 kredi"),
            new (14, 30000,    "Seviye 14" , "@css/seviye14", "[Seviye 14]","1000 kredi"),
            new (15, 40000,    "Seviye 15" , "@css/seviye15", "[Seviye 15]","1000 kredi"),
            new (16, 50000,    "Seviye 16" , "@css/seviye16", "[Seviye 16]","1000 kredi"),
            new (17, 60000,    "Seviye 17" , "@css/seviye17", "[Seviye 17]","1000 kredi"),
            new (18, 70000,    "Seviye 18" , "@css/seviye18", "[Seviye 18]","1000 kredi"),
            new (19, 80000,    "Seviye 19" , "@css/seviye19", "[Seviye 19]","1000 kredi"),
            new (20, 100000,    "Seviye 20" , "@css/seviye20", "[Seviye 20]","1000 kredi"),
            ...
            new (23, 145000,    "Seviye 23" , "@css/seviye23", "[Seviye 23]","23000 kredi"),
            ...
            new (30, 300000,    "Seviye 30" , "@css/seviye30", "[Seviye 30]","ban, hook, god, 10k kredi"),
        };
    }
